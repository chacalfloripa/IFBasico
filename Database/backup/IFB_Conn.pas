...
type
  IIFB_Transaction = interface
  ['{FB4D2CCC-F69D-48CD-ADF7-7FED74A90D8A}']
  ...
  TIFB_Transaction = class(TInterfacedObject, IIFB_Transaction)
  ...
  public
    ...
    property Transaction : TIFB_Transaction read FTransaction write FTransaction;
  end;
